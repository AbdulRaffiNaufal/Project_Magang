...
export default {
        ...
        let harga = 0;
          ...
          for(let employee of this.relationData.employees){
            ...
            if(employee.id == this.dataType.dataRows[3].value){
              ...
              this.dataEmployee.statusBooking = 'Belum bekerja';
            }
          }
      },
      deep:true
  ...
  methods: {
    submitForm() {
      ...
      //validate
      if(this.record['rental_status'] === "Selesai"){
        this.$vs.notify({
      ...
      dataRows['rental_status'] = 'Selesai';
      ...
      this.$api.badasoEntity
        ...
        .then((response) => {
          ...
          .edit({
            slug: 'employees',
            // data: {
            //     id: this.dataType.dataRows[3].value,
            //     statusBooking: 'Belum bekerja'
            //   },
