...
export default {
  ...
  watch: {
    dataType: {
      handler(newValue){
        let total = 0;
          for(let rentals of this.relationData.rentals){
            if(rentals.id == this.dataType.dataRows[1].value){
                total = rentals.totalCost;
            }
          } 
          this.dataType.dataRows[3].value = total;
      },
      deep:true
    }
  },
